...
const (
	Auth_GetToken_FullMethodName = "/OfflinePush.Auth.Auth/GetToken"
	Auth_DelToken_FullMethodName = "/OfflinePush.Auth.Auth/DelToken"
)
...
func (c *authClient) DelToken(ctx context.Context, in *DelTokenReq, opts ...grpc.CallOption) (*DelTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, Auth_DelToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_DelToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_DelToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
